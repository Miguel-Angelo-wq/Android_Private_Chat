...
import 'package:chat/models/app_service.dart';
...
class _BroadcastPromptDialogState extends State<BroadcastPromptDialog> {
  ...
  TextEditingController name =
      TextEditingController(text: DefaultAppService.service.name);

  /// Corresponds to _<this>_._tcp.
  TextEditingController type =
      TextEditingController(text: DefaultAppService.type);
  ...
  TextEditingController port =
      TextEditingController(text: DefaultAppService.port.toString());

  /// Corresponds to the service attributes.
  Map<TextEditingController, TextEditingController> attributes =
      DefaultAppService.service.attributes.map((key, value) => MapEntry(
        ...
        content: SizedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              for (MapEntry<TextEditingController, TextEditingController> entry
              ...
              Padding(
                ...
                child: TextButton.icon(
                  ...
                  onPressed: () {
                    setState(() => attributes[TextEditingController()] =
            ...
            onPressed: () => Navigator.pop(
              ...
              BonsoirService(
                ...
                attributes: attributes
                    .map((key, value) => MapEntry(key.text, value.text)),
              ),
            ),
