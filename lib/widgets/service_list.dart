...
class ServiceList extends StatelessWidget {
  ...
  final Widget? Function(BuildContext, BonsoirService)?
      trailingServiceWidgetBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        for (MapEntry<String, List<BonsoirService>> entry
            in services.entries) ...[
  ...
  static Map<String, List<BonsoirService>> _buildMap(
      Iterable<BonsoirService> services) {
